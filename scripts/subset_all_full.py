...
input = '../data/DepthTaggedVPS_tempsPredict_clean.csv'
...
for id in ids:
    ...
    if not os.path.isfile(output):
        ...
        print('Full temps subset for {} already exists'.format(id))